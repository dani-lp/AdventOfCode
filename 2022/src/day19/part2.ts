...
blueprints.slice(0, 3).forEach((blueprint, bn) => {
  ...
  console.log('Result for', bn + 1, ':', maxGeodes);
  console.log(bn + 1, 'of', blueprints.length, 'finished');
});

// solution
const result = blueprints.reduce((total, blueprint) => total * blueprint.openableGeodes, 1);
